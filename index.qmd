...
format: 
  revealjs:
    multiplex: true
    footer: "[apreshill.github.io/happiest-notebooks-on-earth/](https://apreshill.github.io/happiest-notebooks-on-earth/)"
    theme: ["style.scss"]
    slide-number: c/t
    incremental: true
...
::: columns
::: {.column width="60%"}
There was another human named Jeremy Howard (`@jeremyphoward`), who actually did like notebooks. And shared about a notebook
:::
...
it's my emotional support notebook with perfect style and a data dumpster fire
...
1.  Let them use markdown
2.  Configuration settings - often YAML in the document header or an external file - preferably define own [variables](https://quarto.org/docs/authoring/variables.html)
3.  [Outsource a script or document](https://bookdown.org/yihui/rmarkdown-cookbook/child-document.html)
4.  [Reuse code chunks in different places](https://bookdown.org/yihui/rmarkdown-cookbook/reuse-chunks.html)
5.  Allow for conditional evaluation of code
:::
...
::: {.column width="50%"}
![](img/image-from-rawpixel-id-5906603-jpeg.jpg)
:::
:::
...
4.  Extract all code into a script
...
What does this mean? Make it easier for me to get a link, make it easier for me

link

facade

hide my gnarly code (with utilidoors)

junk drawer for my code that doesn't work
...
1.  *Suspended reality* --- provide utilidors to save their sanity and their code

. . .

2.  *Multisensory experience* --- provide navigation and organization to make notebooks smell better to everyone
